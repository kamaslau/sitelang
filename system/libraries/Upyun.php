<?php
	...
	/*}}}*/
		...
		* @return object
		*/
		public function __construct($params/*$bucketname, $username, $password, $endpoint = NULL, $timeout = 30 */) {/*{{{*/
			$this->_bucketname = $params['bucketname'];
			$this->_username = $params['username'];
			$this->_password = md5($params['password']);
	        $this->_timeout = $params['timeout'];

	        $this->endpoint = is_null($params['endpoint']) ? self::ED_AUTO : $params['endpoint'];
		}/*}}}*/
