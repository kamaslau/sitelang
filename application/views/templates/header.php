			...
			<nav class=container-fluid>
				...
				<div class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<?php else: ?>
						<li><a title="个人中心" href="<?php echo base_url('stuff/'.$this->input->cookie($this->config->item('cookie_prefix').'manager_id')); ?>"><span class="glyphicon glyphicon-user"></span> <?php echo $this->session->userdata('lastname').$this->session->userdata('firstname'); ?></a></li>
