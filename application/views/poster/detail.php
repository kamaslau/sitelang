...
<div id=content>
	<h2>“<?php echo $poster[0]['name']; ?>”广告位业绩</h2>
	<div id=chart>
		<script>
		$(function(){
		    $('#chart').highcharts({
...
?>
	...
	<table id=table class="table table-condensed table-hover table-responsive table-striped sortable">
		<thead>
			<tr><th>推广人身份</th><th>推广人</th><th>活动</th><th>素材</th><th>访问来源</th><th>会员<br>（若为青岛店会员）</th><th>访客IP</th><th>访客设备</th><th>到访时间</th></tr>
		</thead>
		<tbody>
		...
		<?php foreach ($referrals as $referral_item): ?>
			<tr>
				...
				<td>ID <a href="<?php echo base_url('ad/'.$referral_item['ad_id']); ?>" target=_blank><?php echo $referral_item['ad_id']; ?></a></td>
