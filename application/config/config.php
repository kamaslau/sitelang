...
define('SITE_NAME', '半岛店'); // 可在视图文件等处使用的站点名称
define('BASE_URL', 'http://www.bandaodian.com/');

define('TIME_ZONE', 'Asia/Shanghai');
define('IMAGES_URL', 'http://images.bandaodian.com/');
define('COOKIE_DOMAIN', '.bandaodian.com'); // 用于cookie存储路径
...
|
*/
$config['time_reference'] = TIME_ZONE;
